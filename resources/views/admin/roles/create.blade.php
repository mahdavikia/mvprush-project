            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        ...
                        <form role="form" class="forms-sample" action="{{ route('admin.roles.store') }}" method="POST">
                            @csrf
                            @method('POST')
                            <div class="form-body col-md-12" >
                                ...
                                <div class="mb-3 col-md-4 @error('name') has-error @enderror">
                                    ...
                                    <input type="text" name="name" id="name" value="" style="text-align:left;direction:ltr;" class="form-control">
                                    @error('name')
                                    <span class="help-block">{{$message}}</span>
                                    @enderror
                                </div>
