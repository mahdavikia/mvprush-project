    ...
    <div class="example">
        <nav class="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">ویرایش {{$setting->name}}</li>
            </ol>
        </nav>
    </div>
                        ...
                        <form role="form"  action="{{ route('admin.settings.update',$setting) }}" method="POST">
                            ...
                            <div class="form-body  col-md-12 @error('name') has-error @enderror">
                                <div class="form-group col-md-3">
                                    <label>نام (غیرقابل تغییر)</label>
                                    <input type="text" name="name" value="{{$setting->name}}" class="form-control" readonly="readonly" required>
