...
if(!$isAuthorized){
    ...
    die('دسترسی به این بخش ممکن نیست');
}
...
$config['licenseKey']  = 'H6H6FHVESYX33THK3QBG5QDDFEKEA';
...
$config['backends'][] = array(
    ...
    'adapter'      => 'local',
    'baseUrl'      => '/uploads',
//    'root'         => './uploads', // Can be used to explicitly set the CKFinder user files directory.
    'chmodFiles'   => 0777,
    'chmodFolders' => 0755,
